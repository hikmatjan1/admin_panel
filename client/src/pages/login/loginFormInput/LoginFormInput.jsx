...
const LoginFormInput = () => {
    ...
    return (
        <div className="registerFormCenterContent" ref={registerFormCenterContentref}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="registerFormElement">
                <div className="registerFormElementContent">
                    <HiOutlineMail />
                    <input {...register('email', { required: true })} type="email" placeholder="Email" className="registerInput" autoComplete="true" />
                </div>
                {errors.email && <p className="error">Email is required.</p>}
                <div className="registerFormElementContent">
                    <HiOutlineLockClosed />
                    <input {...register('password', { required: true })} type="password" autoComplete="true" placeholder="Password" className="registerInput" />
                </div>
                {errors.password && <p className="error">Password is required.</p>}
                <input type="submit" value="Sign In" ref={disableInputref} className="registerBtn" autoComplete="true" />
            </form>
        </div>
    )
}
