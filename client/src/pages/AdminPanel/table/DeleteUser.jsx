...
const DeleteUser = ({ currentUser, setUsers, inputs_ref, users }) => {
    ...
    return (
        <>
            <button className="btn btn-secondary d-flex align-items-center" onClick={() => setDeleteModal(true)}><AiOutlineDelete />Delete</button>
                ...
                <div className="delete_user_modal_container">
                    <div className="delete_user_modal_wrapper">
                        ...
                        <div className="delete_user_btns">
                            <button type="button" onClick={() => setDeleteModal(false)}>Cancel</button>
